  ...
  return (
    <div className="customer">
          ...
          <TableBody className="custom-table-body">
            {customers.length > 0 ? (
              customers.map((customer) => (
                <TableRow key={customer.siNo} sx={{ backgroundColor: 'white', color: 'black' }}>
      ...
      <Menu anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={handleMenuClose}>
        ...
        <MenuItem>Export Pending Report</MenuItem>
      </Menu>

      <Dialog open={openDialog} onClose={handleDialogClose} fullWidth maxWidth="sm">
        <DialogTitle>Enter Customer Details <IconButton
              edge="end"
              color="inherit"
      ...
      <Dialog open={openEditDialog} onClose={() => setOpenEditDialog(false)}>
        <DialogTitle>Edit Customer<IconButton
              edge="end"
              color="inherit"
